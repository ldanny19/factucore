...
public class EnumeracionXsd implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_enumeracion_xsd", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "enumeracion_xsd", allocationSize = 1)
	private Long id;
