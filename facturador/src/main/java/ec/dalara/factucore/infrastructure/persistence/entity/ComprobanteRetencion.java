...
public class ComprobanteRetencion implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_comprobante_retencion", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "comprobante_retencion", allocationSize = 1)
	private Long id;
