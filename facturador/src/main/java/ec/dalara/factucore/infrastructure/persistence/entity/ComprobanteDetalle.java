...
public class ComprobanteDetalle implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_comprobante_detalle", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "comprobante_detalle", allocationSize = 1)
	private Long id;
