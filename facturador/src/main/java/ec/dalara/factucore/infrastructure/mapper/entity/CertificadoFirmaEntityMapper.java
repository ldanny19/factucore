...
public interface CertificadoFirmaEntityMapper {
 default CertificadoFirmaModel toModel(CertificadoFirma e){if(e==null)return null;return new CertificadoFirmaModel(e.getEmpresa().getId(),e.getNombreArchivo(),e.getRutaCertificado(),e.getFechaInicio(),e.getFechaFin());}
