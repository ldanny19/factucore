...
public interface ComprobanteInformacionAdicionalMapper {
    ...
    ComprobanteInformacionAdicional toEntity(
            ComprobanteInformacionAdicionalRequest request
    );

    @Mapping(target = "idComprobante", source = "comprobante.id")
    ComprobanteInformacionAdicionalResponse toResponse(
            ComprobanteInformacionAdicional entity
    );
