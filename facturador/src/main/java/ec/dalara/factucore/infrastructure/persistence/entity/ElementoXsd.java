...
public class ElementoXsd implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_elemento_xsd", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "elemento_xsd", allocationSize = 1)
	private Long id;
