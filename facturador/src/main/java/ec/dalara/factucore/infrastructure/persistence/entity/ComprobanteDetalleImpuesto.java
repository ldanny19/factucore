...
public class ComprobanteDetalleImpuesto implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_comprobante_detalle_impuesto", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "comprobante_detalle_impuesto", allocationSize = 1)
	private Long id;
