...
public class AtributoXsd implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_atributo_xsd", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "atributo_xsd", allocationSize = 1)
	private Long id;
