...
public class JpaSecuencialAdapter implements SecuencialPort {
	...
	@Override
	@Transactional
	public String obtenerSiguiente(Long puntoEmisionId, String codigoDocumento) {
		...
		Secuencial secuencial = secuencialRepository
				.findByPuntoEmisionIdAndCodigoDocumentoAndEstadoRegistro(puntoEmisionId, codigoDocumento, ESTADO_ACTIVO)
