...
public interface VersionDocumentoXsdMapper {
	...
	default VersionDocumentoXsdModel toModel(VersionDocumentoXsd entity) {
		if (entity == null) {
			return null;
		}

		return new VersionDocumentoXsdModel(entity.getId(), entity.getDocumentoXsd().getId(), entity.getVersion(),
