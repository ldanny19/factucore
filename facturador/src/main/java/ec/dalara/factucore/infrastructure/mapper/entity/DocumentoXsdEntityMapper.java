...
public interface DocumentoXsdEntityMapper {
 default DocumentoXsdModel toModel(DocumentoXsd e){if(e==null)return null;return new DocumentoXsdModel(e.getCodigo(),e.getNombre(),e.getDescripcion(),e.getTipoDocumento());}
