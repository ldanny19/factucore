...
public interface VersionDocumentoXsdEntityMapper {
 default VersionDocumentoXsdModel toModel(VersionDocumentoXsd e){if(e==null)return null;return new VersionDocumentoXsdModel(e.getId(),e.getDocumentoXsd().getId(),e.getVersion(),e.getNamespaceXml(),e.getElementoRaiz(),e.getFechaInicio(),e.getFechaFin());}
