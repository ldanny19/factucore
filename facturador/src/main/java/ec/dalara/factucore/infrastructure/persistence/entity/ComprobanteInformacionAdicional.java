...
public class ComprobanteInformacionAdicional implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_comprobante_informacion_adicional", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "comprobante_informacion_adicional", allocationSize = 1)
	private Long id;
