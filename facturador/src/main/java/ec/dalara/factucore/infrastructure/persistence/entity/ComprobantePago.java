...
public class ComprobantePago implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_comprobante_pago", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "comprobante_pago", allocationSize = 1)
	private Long id;
