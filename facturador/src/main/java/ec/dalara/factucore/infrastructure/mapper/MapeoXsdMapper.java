...
public interface MapeoXsdMapper {
	...
	default MapeoXsdModel toModel(MapeoXsd entity) {
		...
		return new MapeoXsdModel(entity.getId(), entity.getVersionDocumentoXsd().getId(), entity.getRutaOrigen(),
				entity.getElementoXsd() == null ? null : entity.getElementoXsd().getId(),
				entity.getAtributoXsd() == null ? null : entity.getAtributoXsd().getId(), entity.getTipoMapeo());
	}
}