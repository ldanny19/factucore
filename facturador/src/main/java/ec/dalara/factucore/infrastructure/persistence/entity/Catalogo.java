...
public class Catalogo implements EstadoRegistroEntity {
	...
	@TableGenerator(name = "generador_catalogo", table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "next_val", pkColumnValue = "catalogo", allocationSize = 1)
	private Long id;
