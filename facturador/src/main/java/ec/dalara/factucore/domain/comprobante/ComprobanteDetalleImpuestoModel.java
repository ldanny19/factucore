...
public class ComprobanteDetalleImpuestoModel {
	...
	public ComprobanteDetalleImpuestoModel(String codigoImpuesto, String codigoPorcentaje, BigDecimal tarifa,
			BigDecimal baseImponible, BigDecimal valor, BigDecimal valorDevolucionIva) {
