...
public class ConfiguracionEmpresaModel {
	...
	public ConfiguracionEmpresaModel(Long empresaId, String clave, String valor, String tipoDato,
			LocalDateTime fechaVigenciaDesde, LocalDateTime fechaVigenciaHasta) {
