...
public class ElementoXsdModel {
	...
	public ElementoXsdModel(Long id, Long versionDocumentoXsdId, Long elementoPadreId, String nombre, String tipoDato,
			Integer orden, Boolean obligatorio, Boolean repetible, Integer minOcurrencias, Integer maxOcurrencias,
			Integer longitudMinima, Integer longitudMaxima, Integer digitosTotales, Integer decimales,
