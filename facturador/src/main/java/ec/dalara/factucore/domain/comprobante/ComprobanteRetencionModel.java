...
public class ComprobanteRetencionModel {
	...
	public ComprobanteRetencionModel(String codigoImpuesto, String codigoRetencion, BigDecimal porcentajeRetener,
			BigDecimal baseImponible, BigDecimal valorRetenido, String numeroDocumentoSustento,
