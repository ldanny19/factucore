...
public class CamelWorkflowExecutionAdapter
        implements WorkflowExecutionPort {

    private static final String ENDPOINT_PROCESAR =
            "direct:facturador.workflow.procesar";

    private static final String ENDPOINT_REPROCESAR =
            "direct:facturador.workflow.reprocesar";

    private final ProducerTemplate producerTemplate;

    @Override
    public ComprobanteGeneracionResponse ejecutar(
            ComprobanteGeneracionRequest request
    ) {
        return producerTemplate.requestBody(
                ENDPOINT_PROCESAR,
                request,
                ComprobanteGeneracionResponse.class
        );
    }
