...
public class ClaveAccesoService
    ...
    public boolean validar(
        ...
        return ClaveAccesoValidator.esValida(
                clave
        );
    }

    public ClaveAccesoModel generarConCodigoNumerico(
            ClaveAccesoDatos datos
    ) {
        if (datos == null) {
            return ClaveAccesoGenerator.generar(
        ...
        ClaveAccesoDatos datosCompletos =
                new ClaveAccesoDatos(
                        datos.fechaEmision(),
                        datos.codigoDocumento(),
                        datos.ruc(),
                        datos.ambiente(),
                        datos.establecimiento(),
                        datos.puntoEmision(),
                        datos.secuencial(),
                        ClaveAccesoCodigoNumericoGenerator.generar(),
                        datos.tipoEmision()
                );
