...
public interface EnumeracionXsdMapper {
    default EnumeracionXsdModel toModel(EnumeracionXsdRequest r) {
        if (r == null) return null;
        return new EnumeracionXsdModel(null, r.getIdElementoXsd(), r.getValor(), r.getDescripcion(), r.getOrden());
    }
