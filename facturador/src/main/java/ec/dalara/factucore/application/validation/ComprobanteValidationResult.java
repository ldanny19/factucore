...
public final class ComprobanteValidationResult {
	...
	public ComprobanteValidationResult(MessageResolver messageResolver) {
		this.messageResolver = messageResolver;
	}

	public void agregarError(String codigo, String campo, Object... parametros) {
		errores.add(crearMensaje(codigo, campo, parametros));
	}

	public void agregarAdvertencia(String codigo, String campo, Object... parametros) {
		advertencias.add(crearMensaje(codigo, campo, parametros));
	}

	public void agregarMensaje(String codigo, String campo, Object... parametros) {
	...
	private MensajeResponse crearMensaje(String codigo, String campo, Object... parametros) {
		return MensajeResponse.builder().codigo(codigo).mensaje(messageResolver.resolver(codigo, parametros))
				.campo(campo).build();
	}
}