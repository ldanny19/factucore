...
public interface ElementoXsdMapper {
 default ElementoXsdModel toModel(ElementoXsdRequest r){if(r==null)return null;return new ElementoXsdModel(null,r.getIdVersionDocumentoXsd(),r.getIdElementoPadre(),r.getNombre(),r.getTipoDato(),r.getOrden(),r.getObligatorio(),r.getRepetible(),r.getMinOcurrencias(),r.getMaxOcurrencias(),r.getLongitudMinima(),r.getLongitudMaxima(),r.getDigitosTotales(),r.getDecimales(),r.getValorMinimo(),r.getValorMaximo(),r.getPatron());}
